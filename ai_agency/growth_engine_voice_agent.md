...
**OUR EDGE:** Done-for-you AI Growth Engine — no contracts, works in ANY vertical, includes the 24/7 voice agent competitors charge extra for.

---

## 🤖 System Prompt for Voice Agent Engine (Bland.ai / Vapi)

Copy and paste the text block below into the System Prompt field of your voice agent.
...
## ⚙️ Vertical-Specific Pain Questions

*If deploying an agent for a specific industry, swap out the main Pain Discovery question with one of these:*

**Restaurants:**
"When someone calls to ask about reservations or catering after hours, what happens? Does it go to voicemail? Because that's usually where the big catering jobs disappear."

**Law Firms:**
"When a potential client calls after 5pm with an urgent legal question — what's their experience? Do they get someone, or do they call your competitor next?"

**Real Estate:**
"When a buyer or seller fills out a form on your site at 9pm, how fast does someone follow up? Because the data shows the agent who responds in under 5 minutes wins the client 80% of the time."

**Ecommerce:**
"What's your abandoned cart recovery like right now? Most ecommerce stores lose 70% of carts — are you following up on those automatically?"

**Home Services / Trades:**
"When an Angi or HomeAdvisor lead comes in, how fast does someone reach out? Because your competitors are calling in under 60 seconds — and the first call wins the job 9 times out of 10."

**Fitness & Wellness:**
"When someone fills out your trial membership form on a Saturday, what happens? Do they hear back that day, or Monday morning when they've already signed up somewhere else?"
