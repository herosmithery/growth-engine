...
import { supabase, type Client as ClientType, type Appointment, type Message, type FollowUp } from '@/lib/supabase';
...
interface ClientWithStatus extends Omit<ClientType, 'status'> {
...
export default function ClientsPage() {
    ...
    async function loadClients() {
        try {
            ...
            const mappedClients: ClientWithStatus[] = (data || []).map((client: any) => ({
                ...client,
    ...
    async function loadClientDetail(clientId: string) {
        ...
        try {
            ...
            const detailData: ClientDetail = {
                ...
                active_sequences: (followUps || []).map(fu => ({
                    id: fu.id,
                    type: fu.type,
                    status: fu.status,
